...
public class SentMailActivity extends LocalizationActivity {
    ...
    private void setToolbar() {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SentMailActivity.this, HomeActivity.class)
    ...
    private void fetchData(){
        ...
        String url = BuildConfig.Get_User_SentMessages + id;
        ...
        if(entry != null){
            try {
                ...
                mDataset.clear();
                mDataset.addAll(0, JsonParser.parseUserSentMail(data));
                mAdapter.notifyDataSetChanged();
                onRefreshComplete();
            ...
            StringRequest strReq = new StringRequest(Request.Method.GET,
                ...
                public void onResponse(String response) {
                    mDataset.clear();
                    mDataset.addAll(0, JsonParser.parseUserSentMail(response));
                    mAdapter.notifyDataSetChanged();
                    onRefreshComplete();

 ...
 */
public class ViewItemProject implements Parcelable {
    private String id;
    ...
    public static Creator<ViewItemProject> getCREATOR() {
        return CREATOR;
    }
    ...
    public ViewItemProject(String id, String title, String description, String start_date, String end_date, String investment_value, String investment_percentage,
    ...
    protected ViewItemProject(Parcel in) {
        id = in.readString();
        title = in.readString();
    ...
    public static final Creator<ViewItemProject> CREATOR = new Creator<ViewItemProject>() {
        @Override
        public ViewItemProject createFromParcel(Parcel in) {
            return new ViewItemProject(in);
        }

        @Override
        public ViewItemProject[] newArray(int size) {
            return new ViewItemProject[size];
        }
    };
}
...
public class CustomFinanceArrayAdapter extends ArrayAdapter<FinanceModel> {
    private LayoutInflater mInflater;
    protected List<FinanceModel> mDataSet;
    protected Context mContext;
    Holder holder;



    public CustomFinanceArrayAdapter(Context context, List<FinanceModel> users) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final FinanceModel bubleItem = mDataSet.get(position);
